...
class CartRuleCouponController extends MarketingController
{
    ...
    public function store(Request $request, int $cartRuleId)
    {
        ...
        return response([
            'message' => trans('Apis::app.admin.marketing.promotions.cart-rule-coupons.create-success'),
        ]);
    }
    ...
    public function destroy(int $cartRuleId, int $id)
    {
        ...
        return response([
            'message' => trans('Apis::app.admin.marketing.promotions.cart-rule-coupons.delete-success'),
        ]);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest, int $cartRuleId)
    {
        ...
        return response([
            'message' => trans('Apis::app.admin.marketing.promotions.cart-rule-coupons.mass-operations.delete-success'),
        ]);
    }
}
