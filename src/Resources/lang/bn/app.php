...
return [
    ...
    'shop' => [
        'customer' => [
            ...
            'code' => [
                'sent' => 'আপনার মোবাইল নম্বরে একটি নিশ্চিতকরণ কোড পাঠানো হয়েছে।',
                'expired' => 'কোড মেয়াদ উত্তীর্ণ হয়েছে। অনুগ্রহ করে নতুন কোড অনুরোধ করুন।',
                'invalid' => 'অবৈধ কোড। আবার চেষ্টা করুন।',
                'verified' => 'মোবাইল নম্বর সফলভাবে যাচাই করা হয়েছে।',
            ],
        ],
